...
import com.lahuca.laneinstance.events.party.PartyAddInvitationEvent;
...
public class PaperPartyCreateEvent extends PaperInstanceEvent<PartyCreateEvent> {

    private static final HandlerList HANDLER_LIST = new HandlerList();

    public PaperPartyCreateEvent(PartyCreateEvent instanceEvent) {
