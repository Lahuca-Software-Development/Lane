 ...
 */
public record DataObjectsSelectPacket(long requestId, @NotNull PermissionKey permissionKey, @NotNull DataSelector selector) implements RequestPacket {

    public static final String packetId = "dataObjectsSelect";

    static {
        Packet.registerPacket(packetId, DataObjectsSelectPacket.class);
    }
